...
f_im = pd.read_csv(f_im_path+'shap_f_importance_lgbm.csv')
...
Kfold = CVFS(random_seed=random_seed, model_name='lgbm', file_name='lgbm')
...
df.to_csv(save_path+'f_select_auc_lgbm.csv')