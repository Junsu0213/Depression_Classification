...
class MLClassifier(object):
    def __init__(self, random_seed, file_name, fig_save=True):
        self.random_seed = random_seed
        self.MLGrid = MLGrid(random_seed=self.random_seed)
        self.fig_save = fig_save
        self.data_split = DataLoader(path=None, random_seed=self.random_seed)
        self.save_path = 'C:\\Users\\User\\Desktop\\PyCharm Projects\\Depression_classification_final\\shap_value_save\\{}\\'.format(file_name)
    ...
    def svm_best(self, x, y, b_para, columns, shap_=True):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='SVM', file_name=self.file_name)
    ...
    def rf_best(self, x, y, b_para, columns, shap_=True):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='Random', file_name=self.file_name)
    ...
    def knn_best(self, x, y, b_para, columns, shap_=True):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='KNN', file_name=self.file_name)
    ...
    def xgb_best(self, x, y, b_para, columns):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='XGboost', file_name=self.file_name)
    ...
    def cat_best(self, x, y, b_para, columns):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='atBoost', file_name=self.file_name)
    ...
    def lgbm_best(self, x, y, b_para, columns):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='lgbm', file_name=self.file_name)
    ...
    def sgd_best(self, x, y, b_para, columns, shap_=True):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='SGD', file_name=self.file_name)
    ...
    def lr_best(self, x, y, b_para, columns, shap_=True):
        ...
        Kfold = CVFS(random_seed=self.random_seed, model_name='logistic regression', file_name=self.file_name)
